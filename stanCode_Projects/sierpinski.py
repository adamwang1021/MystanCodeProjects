...
def main():
	"""
	Used to paint the Sierpinski Triangle.
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	"""
	:param order:int,how many layers
	:param length:int,the length of the triangle
	:param upper_left_x:int, The X-axis position of the triangle
	:param upper_left_y:int, The Y-axis position of the triangle
	...
	if order == 0:
		...
		line_3 = GLine(upper_left_x+length*0.5, upper_left_y+length*0.866, upper_left_x+length, upper_left_y)
		window.add(line_1)
		window.add(line_2)
		window.add(line_3)
		pause(30)
